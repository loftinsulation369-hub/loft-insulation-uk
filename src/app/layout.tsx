...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'theme-color': '#ffffff',
    'google-site-verification': '4_y79LCfipsBMwgAfAbiU4j9OxlQrI9JjSJ8fzjZHhk',
    'yandex-verification': '51d2840a2dab617d',
  },
};
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document, "clarity", "script", "thcv8ti1rg");
            `,
          }}
        />
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-G3N1Q1VBTW"></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
