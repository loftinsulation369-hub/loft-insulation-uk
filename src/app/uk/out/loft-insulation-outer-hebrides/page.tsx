...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Outer Hebrides – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Outer Hebrides and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Outer Hebrides", "loft insulation grants Outer Hebrides", "Outer Hebrides loft insulation scheme", "government free loft insulation Outer Hebrides", "loft insulation installers Outer Hebrides", "energy saving loft insulation Outer Hebrides", "eco loft insulation Outer Hebrides", "free home insulation Outer Hebrides"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/out/loft-insulation-outer-hebrides',
    languages: {
      'en-US': '/uk/out/loft-insulation-outer-hebrides',
      'en-GB': '/uk/out/loft-insulation-outer-hebrides',
      'en': '/uk/out/loft-insulation-outer-hebrides',
    },
  },
  openGraph: {
    title: "Outer Hebrides Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Outer Hebrides. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/out/loft-insulation-outer-hebrides',
    siteName: 'Free Loft Insulation in Outer Hebrides',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-outer-hebrides.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Outer Hebrides',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-outer-hebrides.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Outer Hebrides – Government Grants Available',
    description: 'Outer Hebrides homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-outer-hebrides.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Outer Hebrides',
    'twitter:image:alt': 'Free Loft Insulation in Outer Hebrides',
  },
};

export default function LoftInsulationOuterHebridesPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Outer Hebrides – Keep Your Home Warm & Energy Efficient
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional Loft Insulation Services in the Outer Hebrides
            </p>
            <p className="text-lg mb-8 text-blue-200">
              Living in the beautiful but often chilly Outer Hebrides means your home needs effective insulation to stay warm and reduce energy bills. Our expert loft insulation services provide a cost-effective solution to prevent heat loss, improve comfort, and help protect the environment. Whether you own a traditional croft or a modern house, we tailor our insulation to meet the unique climate and challenges of the Outer Hebrides.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Outer Hebrides homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in the Outer Hebrides
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We offer a comprehensive range of insulation options tailored for island homes:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Effective and affordable</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for filling awkward or hard-to-reach spaces</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Airtight and high-performance solution</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Extra storage space combined with insulation</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Areas We Serve in the Outer Hebrides
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                Our services cover the entire archipelago including:
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Stornoway', 'Barvas', 'Tarbert', 'Leverburgh', 'Castlebay', 'Balivanich'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus all surrounding Outer Hebrides communities
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in the Outer Hebrides?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Local Expertise – Understanding the unique challenges of island living</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">High-Quality Materials – Durable and weather-resistant products</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Affordable Pricing – Energy savings that offset installation costs</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Guaranteed Workmanship – Confidence and peace of mind with every job</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Outer Hebrides Service?</h3>
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-green-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span>Free Island Survey</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-green-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                ...
                <div className="flex items-center">
                  ...
                  <span>Island Climate Expertise</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Outer Hebrides
            </h1>
