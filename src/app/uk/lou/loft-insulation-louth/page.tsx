...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Louth – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Louth and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Louth", "loft insulation grants Louth", "Louth loft insulation scheme", "government free loft insulation Louth", "loft insulation installers Louth", "energy saving loft insulation Louth", "eco loft insulation Louth", "free home insulation Louth"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/lou/loft-insulation-louth',
    languages: {
      'en-US': '/uk/lou/loft-insulation-louth',
      'en-GB': '/uk/lou/loft-insulation-louth',
      'en': '/uk/lou/loft-insulation-louth',
    },
  },
  openGraph: {
    title: "Louth's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Louth. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/lou/loft-insulation-louth',
    siteName: 'Free Loft Insulation in Louth',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-louth.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Louth',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-louth.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Louth – Government Grants Available',
    description: 'Louth homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-louth.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Louth',
    'twitter:image:alt': 'Free Loft Insulation in Louth',
  },
};

export default function LoftInsulationLouthPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Louth – Expert Installation for a Warmer, Energy-Efficient Home
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional Loft Insulation Services in Louth
            </p>
            <p className="text-lg mb-8 text-blue-200">
              At [Your Company Name], we provide high-quality loft insulation in Louth and surrounding Lincolnshire areas, helping homeowners save on energy bills, improve comfort, and reduce heat loss. Our expert team installs insulation to the latest building regulations, ensuring your home is as energy-efficient as possible.
            </p>
            <p className="text-lg mb-8 text-blue-200">
              We work with all property types – from traditional homes to new builds – offering tailored solutions including loft insulation installation, upgrades, and removal of old materials.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Louth homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Louth
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Cost-effective and quick to install – ideal for most standard loft spaces.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for awkward or hard-to-access loft areas.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Best for loft conversions or when the loft is used for storage.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Safe removal of old or damaged insulation before installing fresh, high-performance materials.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="process" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Hassle-Free 4-Step Process
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">We assess your loft space and current insulation levels.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">No hidden costs or pushy sales.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Fast, tidy, and fully compliant with UK regulations.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Guidance to help maintain insulation performance.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Louth?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Local Lincolnshire-based installers</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">10+ years of experience in insulation services</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fully trained, insured, and certified team</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Eco-friendly, high-performance materials</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Areas We Cover Around Louth
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                We serve Louth and nearby areas including:
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Legbourne', 'Manby', 'Grimoldby', 'Fotherby', 'North Thoresby', 'Market Rasen', 'Saltfleetby', 'Mablethorpe'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus surrounding Lincolnshire villages
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Louth Service?</h3>
