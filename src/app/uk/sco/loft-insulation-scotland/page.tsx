...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Scotland – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Scotland and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Scotland", "loft insulation grants Scotland", "Scotland loft insulation scheme", "government free loft insulation Scotland", "loft insulation installers Scotland", "energy saving loft insulation Scotland", "eco loft insulation Scotland", "free home insulation Scotland"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/sco/loft-insulation-scotland',
    languages: {
      'en-US': '/uk/sco/loft-insulation-scotland',
      'en-GB': '/uk/sco/loft-insulation-scotland',
      'en': '/uk/sco/loft-insulation-scotland',
    },
  },
  openGraph: {
    title: "Scotland Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Scotland. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/sco/loft-insulation-scotland',
    siteName: 'Free Loft Insulation in Scotland',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-scotland.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Scotland',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-scotland.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Scotland – Government Grants Available',
    description: 'Scotland homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-scotland.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Scotland',
    'twitter:image:alt': 'Free Loft Insulation in Scotland',
  },
};

export default function LoftInsulationScotlandPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Scotland – Enhance Comfort & Cut Energy Bills Across Scotland
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Scotland homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Loft Insulation is Vital in Scotland
            </h2>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Reduce Energy Bills – Save up to 30% on heating costs</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Improve Home Comfort – Maintain consistent indoor temperatures</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Eco-Friendly – Lower your carbon footprint and energy consumption</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Noise Reduction – Reduce external noise, especially in urban areas</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Increase Property Value – Improve your EPC rating for resale or rental</span>
                  </li>
                </ul>
              </div>
      ...
      <section id="services" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services Across Scotland
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We offer a wide range of insulation options to suit all property types and budgets:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for filling hard-to-reach spaces</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Airtight and high-performance</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Areas We Serve in Scotland
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                Our expert team covers all major cities and regions including:
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Glasgow', 'Edinburgh', 'Aberdeen', 'Dundee', 'Inverness', 'Stirling', 'Perth'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus the Highlands and Islands
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Scotland?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Local Knowledge – Understanding of Scottish homes and weather conditions</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Premium Materials – Durable, eco-friendly insulation products</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Competitive Pricing – Affordable rates with excellent value</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Guaranteed Workmanship – Confidence and peace of mind with every project</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Scotland Service?</h3>
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span>Scottish Climate Expertise</span>
                </div>
              </div>
            </div>
          </div>
