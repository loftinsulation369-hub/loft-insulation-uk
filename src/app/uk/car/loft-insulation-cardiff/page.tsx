...
export const metadata: Metadata = {
  ...
  description: "Apply for free loft insulation in Cardiff and reduce energy bills. Local installers, government grants, and quick approval.",
  ...
  openGraph: {
    ...
    description: "Discover how to get free loft insulation in Cardiff. Cut heat loss, save money, and enjoy a warmer home.",
  ...
  twitter: {
    ...
    description: 'Cardiff homeowners can now qualify for free loft insulation through eco-friendly government schemes. Check eligibility today.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Loft Insulation Cardiff – Save Energy & Stay Warm
            </h1>
            <p className="text-xl text-blue-100 max-w-4xl mx-auto mb-8 font-medium">
              Expert Loft Insulation Services in Cardiff
            </p>
            <p className="text-lg text-blue-200 max-w-4xl mx-auto mb-8">
              We provide professional loft insulation in Cardiff to help homeowners reduce heat loss, lower heating bills, and create a more comfortable living space all year round. With over 10 years of experience and a network of certified installers, we offer insulation solutions that comply with the latest UK energy efficiency standards. Whether your property is a traditional Cardiff terrace, a modern apartment, or a large family home, our experts will recommend the best insulation to suit your needs.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Cardiff homeowners who have already reduced their energy bills</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Our Loft Insulation Options in Cardiff
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We offer a range of insulation solutions to suit different property types and requirements.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">
                Ideal for most lofts – quick to install and highly cost-effective.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                Perfect for hard-to-reach loft spaces and irregular layouts.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                Best suited for loft conversions or when the loft is used for storage or living space.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Loft Insulation Removal & Replacement</h3>
              </div>
              <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">We inspect your loft and assess your insulation needs.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Tailored Plan</h3>
              <p className="text-gray-600">Recommendations based on your property and budget.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Quick, clean, and compliant with UK regulations.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Ensuring maximum efficiency and performance.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Us for Loft Insulation in Cardiff?
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Eco-friendly materials</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Cardiff Areas We Serve
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We provide loft insulation across Cardiff including Cathays, Roath, Canton, Penarth, Grangetown, and surrounding areas.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Cardiff City</h3>
              </div>
              <p className="text-gray-600">Complete coverage of Cardiff with local expertise and understanding.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Cathays & Roath</h3>
              </div>
              <p className="text-gray-600">Extensive coverage of Cathays, Roath, and Canton.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Penarth & Grangetown</h3>
              </div>
              <p className="text-gray-600">We reach Penarth, Grangetown, and surrounding South Wales areas.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Get Your Free Loft Insulation Quote in Cardiff Today
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-4xl mx-auto">
            Stop losing heat and money through your roof. Upgrade to professional loft insulation in Cardiff today.
          </p>
