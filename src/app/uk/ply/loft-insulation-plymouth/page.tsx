...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Plymouth – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Plymouth and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Plymouth", "loft insulation grants Plymouth", "Plymouth loft insulation scheme", "government free loft insulation Plymouth", "loft insulation installers Plymouth", "energy saving loft insulation Plymouth", "eco loft insulation Plymouth", "free home insulation Plymouth"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/ply/loft-insulation-plymouth',
    languages: {
      'en-US': '/uk/ply/loft-insulation-plymouth',
      'en-GB': '/uk/ply/loft-insulation-plymouth',
      'en': '/uk/ply/loft-insulation-plymouth',
    },
  },
  openGraph: {
    title: "Plymouth Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Plymouth. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/ply/loft-insulation-plymouth',
    siteName: 'Free Loft Insulation in Plymouth',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-plymouth.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Plymouth',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-plymouth.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Plymouth – Government Grants Available',
    description: 'Plymouth homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-plymouth.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Plymouth',
    'twitter:image:alt': 'Free Loft Insulation in Plymouth',
  },
};

export default function LoftInsulationPlymouthPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Plymouth – Keep Your Home Warm & Save on Energy Bills
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Plymouth homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Plymouth
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We offer a comprehensive range of insulation options tailored for Plymouth homes:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for filling awkward loft spaces</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                Our expert team covers Plymouth and nearby areas including:
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Devonport', 'Plympton', 'Plymstock', 'Mutley', 'Weston Mill', 'Southway'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus all surrounding Plymouth areas
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Plymouth?
            </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Plymouth Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Plymouth
            </h1>
