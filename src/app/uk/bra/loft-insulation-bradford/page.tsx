...
export const metadata: Metadata = {
  ...
  description: "Apply for free loft insulation in Bradford and reduce energy bills. Local installers, government grants, and quick approval.",
  ...
  openGraph: {
    ...
    description: "Discover how to get free loft insulation in Bradford. Cut heat loss, save money, and enjoy a warmer home.",
  ...
  twitter: {
    ...
    description: 'Bradford homeowners can now qualify for free loft insulation through eco-friendly government schemes. Check eligibility today.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Loft Insulation Bradford – Keep Your Home Warm & Energy-Efficient
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Bradford homeowners who have already reduced their energy bills</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Our Loft Insulation Services in Bradford
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">
                We use high-performance, eco-friendly insulation materials to maximise efficiency.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                Replace old or ineffective insulation with modern, long-lasting options.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                Enjoy extra storage space without losing insulation benefits.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Insulation Health Checks</h3>
              </div>
              <p className="text-gray-600">
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Us for Loft Insulation in Bradford
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Serving Bradford households</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Fully Certified</h3>
              <p className="text-gray-600">Trained installers</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Efficient installations</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
      ...
      <section className="py-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Our Simple Loft Insulation Process
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Free Home Survey</h3>
              <p className="text-gray-600">We inspect your loft space and discuss your needs.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Honest and competitive pricing.</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Enjoy Savings</h3>
              <p className="text-gray-600">Lower energy bills from day one.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Serving All Areas of Bradford
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We provide loft insulation services across Bradford including Shipley, Bingley, Keighley, Pudsey, Thornton, Ilkley, Baildon, and nearby towns.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Bradford City</h3>
              </div>
              <p className="text-gray-600">Complete coverage of Bradford with local expertise and understanding.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Shipley & Bingley</h3>
              </div>
              <p className="text-gray-600">Extensive coverage of Shipley, Bingley, Keighley, and Pudsey.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Thornton & Ilkley</h3>
              </div>
              <p className="text-gray-600">We reach Thornton, Ilkley, Baildon, and surrounding areas.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Get Your Free Loft Insulation Quote in Bradford Today
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-4xl mx-auto">
            Stop losing heat and money through your roof. Contact us for a free survey and quote for loft insulation in Bradford.
          </p>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              FAQs – Loft Insulation Bradford
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Get answers to the most commonly asked questions about loft insulation in Bradford.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  How much does loft insulation cost in Bradford?
                </h3>
                <p className="text-gray-700 ml-9">
                  Costs vary depending on the size of your loft and insulation type, but we offer affordable pricing.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  Can I get a grant for loft insulation in Bradford?
                </h3>
                <p className="text-gray-700 ml-9">
                  Yes – you may be eligible for funding through ECO4 or other UK government schemes.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  Will loft insulation help in summer?
                </h3>
                <p className="text-gray-700 ml-9">
                  Yes – it keeps heat out in summer, making your home cooler.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                ...
                <p className="text-gray-700 ml-9">
                  Yes – we can safely remove and dispose of old insulation before installing new material.
                </p>
              </div>
            </div>
          </div>
