        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Loft Insulation Belfast – Keep Your Home Warm & Energy-Efficient
            </h1>
            <p className="text-xl text-blue-100 max-w-4xl mx-auto mb-8 font-medium">
              Expert Loft Insulation Services in Belfast
            </p>
            <p className="text-lg text-blue-200 max-w-4xl mx-auto mb-8">
              Looking for professional loft insulation in Belfast? We provide expert installation, replacement, and upgrades for homes across Belfast and Northern Ireland. Our certified installers use high-quality, eco-friendly insulation materials to help you reduce heat loss, cut energy bills, and improve comfort in every season.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                Why Loft Insulation is Essential in Belfast
              </h2>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Belfast experiences a temperate climate with cool winters and mild summers, making effective loft insulation critical to maintain energy efficiency and indoor comfort. Without proper insulation, up to 25% of your home's heat can escape through the roof.
              </p>
            </div>
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Belfast homeowners who have already reduced their energy bills</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Our Loft Insulation Services in Belfast
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">
                We fit premium-grade insulation to UK energy standards, ensuring maximum efficiency.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                Upgrade old, damaged, or ineffective insulation with modern, high-performance materials.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 md:col-span-2">
              ...
              <p className="text-gray-600">
                Create safe storage space while keeping your insulation intact and effective.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Us for Loft Insulation in Belfast
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Experienced with Belfast's housing styles and insulation needs</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Fast & Tidy Installation</h3>
              <p className="text-gray-600">Most projects completed within a day</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Affordable & Transparent Pricing</h3>
              <p className="text-gray-600">No hidden costs, just honest quotes</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Fully Accredited & Insured</h3>
              <p className="text-gray-600">Work carried out to UK building regulations</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Free Home Assessment</h3>
              <p className="text-gray-600">We inspect your loft and recommend the best insulation.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">No-Obligation Quote</h3>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Carried out by our trained and certified team.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Lower bills, warmer winters, cooler summers.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Serving Belfast & Surrounding Areas
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We provide loft insulation in Belfast and across Northern Ireland, including Lisburn, Newtownabbey, Bangor, Carrickfergus, and beyond.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Belfast City</h3>
              </div>
              <p className="text-gray-600">Complete coverage of Belfast with local expertise and understanding.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Northern Ireland</h3>
              </div>
              <p className="text-gray-600">Extensive coverage across Northern Ireland including Lisburn and Newtownabbey.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Bangor & Carrickfergus</h3>
              </div>
              <p className="text-gray-600">We reach Bangor, Carrickfergus, and surrounding areas with dedicated service.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Get a Free Loft Insulation Quote in Belfast
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-4xl mx-auto">
            Start saving money and energy today. Contact our friendly team for a free, no-obligation loft insulation survey in Belfast.
          </p>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              FAQs – Loft Insulation Belfast
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Get answers to the most commonly asked questions about loft insulation in Belfast.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  How much does loft insulation cost in Belfast?
                </h3>
                <p className="text-gray-700 ml-9">
                  It depends on loft size and materials, but we offer affordable packages to suit every budget.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  Do you provide loft insulation grants in Belfast?
                </h3>
                <p className="text-gray-700 ml-9">
                  Yes, we can help check if you qualify for ECO4 or Northern Ireland energy efficiency grants.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                ...
                <p className="text-gray-700 ml-9">
                  Our premium insulation lasts up to 40 years with little to no maintenance.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                ...
                <p className="text-gray-700 ml-9">
                  DIY is possible, but professional installation ensures safety, compliance, and optimal results.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                ...
                <p className="text-gray-700 ml-9">
                  Immediately – your home will feel warmer, and your energy bills will drop from the first month.
                </p>
              </div>
            </div>
          </div>
