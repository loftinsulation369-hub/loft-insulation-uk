...
export const metadata: Metadata = {
  ...
  description: "Apply for free loft insulation in Brighton and reduce energy bills. Local installers, government grants, and quick approval.",
  ...
  openGraph: {
    ...
    description: "Discover how to get free loft insulation in Brighton. Cut heat loss, save money, and enjoy a warmer home.",
  ...
  twitter: {
    ...
    description: 'Brighton homeowners can now qualify for free loft insulation through eco-friendly government schemes. Check eligibility today.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Loft Insulation Brighton – Stay Warm, Save Money & Go Green
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Brighton homeowners who have already reduced their energy bills</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Our Loft Insulation Services in Brighton
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">
                We install premium, high-performance insulation materials to retain heat efficiently.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                Replace outdated insulation with advanced, long-lasting alternatives.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                Enjoy more storage space without sacrificing energy efficiency.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                We inspect your current insulation and recommend improvements.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Us for Loft Insulation in Brighton
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Insulation expertise</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Fully Trained & Certified</h3>
              <p className="text-gray-600">Professional installers</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Honest quotes</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              How Our Loft Insulation Process Works
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Transparent Quote</h3>
              <p className="text-gray-600">Fair pricing with no surprises.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Quick, tidy, and hassle-free.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Energy Savings</h3>
              <p className="text-gray-600">Start saving money from day one.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Serving All Areas of Brighton & Beyond
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We provide loft insulation services in Brighton, Hove, Portslade, Shoreham-by-Sea, Peacehaven, Lewes, Newhaven, and surrounding areas.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Brighton & Hove</h3>
              </div>
              <p className="text-gray-600">Complete coverage of Brighton and Hove with local expertise and understanding.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Portslade & Shoreham</h3>
              </div>
              <p className="text-gray-600">Extensive coverage of Portslade, Shoreham-by-Sea, and Peacehaven.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Lewes & Newhaven</h3>
              </div>
              <p className="text-gray-600">We reach Lewes, Newhaven, and surrounding Sussex areas.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              FAQs – Loft Insulation Brighton
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Get answers to the most commonly asked questions about loft insulation in Brighton.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  How much does loft insulation cost in Brighton?
                </h3>
                <p className="text-gray-700 ml-9">
                  It depends on loft size and material type, but we offer competitive pricing.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  Can I get funding for loft insulation in Brighton?
                </h3>
                <p className="text-gray-700 ml-9">
                  Yes – many homes qualify for grants through ECO4 and other government schemes.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700 ml-9">
                  Absolutely – it keeps unwanted heat out, making your home cooler.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                ...
                <p className="text-gray-700 ml-9">
                  Yes – we offer safe removal and disposal before installing your new insulation.
                </p>
              </div>
            </div>
          </div>
