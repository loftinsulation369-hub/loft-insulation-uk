...
import LoftInsulationLondonStructuredData from '@/components/LoftInsulationLondonStructuredData';
...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
    ...
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-london.webp',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-london.webp'],
    creator: '@l4rgindia',
  },
  alternates: {
    canonical: 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
    languages: {
      'en-US': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-GB': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-AE': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'de-DE': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'es-ES': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'fr-FR': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'pt-BR': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-CA': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-MY': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-SG': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-NG': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-ID': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-IE': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-AU': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-IN': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-NZ': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-PH': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'en-ZA': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'es-MX': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'es-CO': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'es-PE': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'es-AR': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'es-CL': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'es-VE': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'pt-PT': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'fr-CA': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
      'fr-BE': 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-london',
    },
  },
  robots: {
    index: true,
  ...
  other: {
    ...
    'og:type': 'website',
    'og:locale': 'en_GB',
    'og:locale:alternate': 'en-US',
    'og:locale:alternate:en-GB': 'en-GB',
    'og:locale:alternate:en': 'en',
    'og:locale:alternate:en-AE': 'en-AE',
    'og:locale:alternate:de-DE': 'de-DE',
    'og:locale:alternate:es-ES': 'es-ES',
    'og:locale:alternate:fr-FR': 'fr-FR',
    'og:locale:alternate:pt-BR': 'pt-BR',
    'og:locale:alternate:en-CA': 'en-CA',
    'og:locale:alternate:en-MY': 'en-MY',
    'og:locale:alternate:en-SG': 'en-SG',
    'og:locale:alternate:en-NG': 'en-NG',
    'og:locale:alternate:en-ID': 'en-ID',
    'og:locale:alternate:en-IE': 'en-IE',
    'og:locale:alternate:en-AU': 'en-AU',
    'og:locale:alternate:en-IN': 'en-IN',
    'og:locale:alternate:en-NZ': 'en-NZ',
    'og:locale:alternate:en-PH': 'en-PH',
    'og:locale:alternate:en-ZA': 'en-ZA',
    'og:locale:alternate:es-MX': 'es-MX',
    'og:locale:alternate:es-CO': 'es-CO',
    'og:locale:alternate:es-PE': 'es-PE',
    'og:locale:alternate:es-AR': 'es-AR',
    'og:locale:alternate:es-CL': 'es-CL',
    'og:locale:alternate:es-VE': 'es-VE',
    'og:locale:alternate:pt-PT': 'pt-PT',
    'og:locale:alternate:fr-CA': 'fr-CA',
    'og:locale:alternate:fr-BE': 'fr-BE',
  },
};
...
export default function LoftInsulationLondon() {
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      {/* Structured Data */}
      <LoftInsulationLondonStructuredData />
    </div>
  );
}
