...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Londonderry – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Londonderry and reduce energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Londonderry", "loft insulation grants Londonderry", "Londonderry loft insulation scheme", "government free loft insulation Londonderry", "loft insulation installers Londonderry", "energy saving loft insulation Londonderry", "eco loft insulation Londonderry", "free home insulation Londonderry"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/lon/loft-insulation-londonderry',
    languages: {
      'en-US': '/uk/lon/loft-insulation-londonderry',
      'en-GB': '/uk/lon/loft-insulation-londonderry',
      'en': '/uk/lon/loft-insulation-londonderry',
    },
  },
  openGraph: {
    title: "Londonderry's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Londonderry. Save money, reduce heat loss, and have a cozier home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/lon/loft-insulation-londonderry',
    siteName: 'Free Loft Insulation in Londonderry',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-londonderry.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Londonderry',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-londonderry.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Londonderry – Government Grants Available',
    description: 'Homeowners in Londonderry may now be eligible for free loft insulation under government schemes. Check your eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-londonderry.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Londonderry',
    'twitter:image:alt': 'Free Loft Insulation in Londonderry',
  },
};

export default function LoftInsulationLondonderryPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Londonderry – Keep Your Home Warm & Energy Bills Low
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional Loft Insulation Services in Londonderry
            </p>
            <p className="text-lg mb-8 text-blue-200">
              At [Your Company Name], we specialise in providing high-quality loft insulation in Londonderry, helping homeowners and landlords improve energy efficiency, reduce heating costs, and enjoy a warmer home. We serve the entire Londonderry area, including the city centre, Waterside, Culmore, Eglinton, and surrounding towns.
            </p>
            <p className="text-lg mb-8 text-blue-200">
              Whether you need a full loft insulation installation, a top-up to meet current building regulations, or safe removal and replacement of old insulation, our certified team delivers reliable, eco-friendly solutions tailored to your home.
            </p>
  ...
  {/* Why Loft Insulation Matters Section */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Londonderry homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Loft Insulation in Londonderry Matters
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <p className="text-lg text-gray-600">
                  Without proper insulation, up to 25% of heat escapes through your roof, leading to higher energy bills and a less comfortable home. Installing or upgrading your loft insulation offers:
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Significant savings on heating costs</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Year-round temperature control – warmer in winter, cooler in summer</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Improved Energy Performance Certificate (EPC) rating</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Access to government energy efficiency grants (if eligible)</span>
                  </li>
                </ul>
              </div>
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-green-600">Up to £300</span>
                  </div>
                  <div className="flex justify-between items-center">
      ...
      <section id="services" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Londonderry
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for standard loft spaces – cost-effective and quick to install.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for hard-to-reach or irregular loft areas.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Rigid Board Insulation</h3>
                <p className="text-gray-600">Best choice for loft conversions or storage areas.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Loft Insulation Removal & Replacement</h3>
                <p className="text-gray-600">Safe, clean removal of old or damaged insulation before fitting new materials.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Free Home Survey</h3>
                <p className="text-gray-600">We assess your loft space and insulation needs.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-green-600">2</span>
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">No-Obligation Quote</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Professional Installation</h3>
                <p className="text-gray-600">Quick, tidy, and fully compliant with UK standards.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Ensuring long-lasting performance.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Londonderry?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fully qualified, insured, and local installers</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">High-performance, eco-friendly insulation materials</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Competitive prices with flexible payment options</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Thousands of happy customers across Northern Ireland</h3>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Londonderry City Centre', 'Waterside', 'Culmore', 'Eglinton', 'Drumahoe', 'Newbuildings', 'Strathfoyle', 'Culmore Point'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus surrounding villages and rural areas
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Londonderry Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Londonderry
            </h1>
