...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Middlesbrough – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Middlesbrough and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Middlesbrough", "loft insulation grants Middlesbrough", "Middlesbrough loft insulation scheme", "government free loft insulation Middlesbrough", "loft insulation installers Middlesbrough", "energy saving loft insulation Middlesbrough", "eco loft insulation Middlesbrough", "free home insulation Middlesbrough"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/mid/loft-insulation-middlesbrough',
    languages: {
      'en-US': '/uk/mid/loft-insulation-middlesbrough',
      'en-GB': '/uk/mid/loft-insulation-middlesbrough',
      'en': '/uk/mid/loft-insulation-middlesbrough',
    },
  },
  openGraph: {
    title: "Middlesbrough's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Middlesbrough. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/mid/loft-insulation-middlesbrough',
    siteName: 'Free Loft Insulation in Middlesbrough',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-middlesbrough.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Middlesbrough',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-middlesbrough.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Middlesbrough – Government Grants Available',
    description: 'Middlesbrough homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-middlesbrough.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Middlesbrough',
    'twitter:image:alt': 'Free Loft Insulation in Middlesbrough',
  },
};

export default function LoftInsulationMiddlesbroughPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Middlesbrough – Reduce Heat Loss & Save on Energy Bills
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Middlesbrough homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Middlesbrough
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We offer a complete range of loft insulation options to suit every property:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Affordable and effective for most lofts</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for hard-to-reach loft spaces</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Loft Boarding & Storage Solutions</h3>
                <p className="text-gray-600">Combine insulation with usable storage space</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Serving All Middlesbrough Areas
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                From Acklam, Linthorpe, and Marton to Hemlington, Nunthorpe, and Coulby Newham, our local experts are ready to help. We only use trusted, premium materials to guarantee long-lasting results.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Acklam', 'Linthorpe', 'Marton', 'Hemlington', 'Nunthorpe', 'Coulby Newham', 'Ormesby', 'Easterside'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus all surrounding Middlesbrough areas
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Middlesbrough?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Local Expertise – We understand the needs of Middlesbrough homes</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Affordable Pricing – Quality insulation at competitive rates</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Environmentally Friendly Materials – Safe and sustainable solutions</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Quick & Hassle-Free Installation – Minimal disruption to your routine</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fully Insured & Guaranteed – Your peace of mind is our priority</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Get Your Free Loft Insulation Quote in Middlesbrough
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Take the first step toward a warmer, more energy-efficient home. Contact us today for a free survey and no-obligation quote. Our friendly team will recommend the best insulation option for your property.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Middlesbrough Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Middlesbrough
            </h1>
