...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Whitby – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Whitby and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Whitby", "loft insulation grants Whitby", "Whitby loft insulation scheme", "government free loft insulation Whitby", "loft insulation installers Whitby", "energy saving loft insulation Whitby", "eco loft insulation Whitby", "free home insulation Whitby"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/whi/loft-insulation-whitby',
    languages: {
      'en-US': '/uk/whi/loft-insulation-whitby',
      'en-GB': '/uk/whi/loft-insulation-whitby',
      'en': '/uk/whi/loft-insulation-whitby',
    },
  },
  openGraph: {
    title: "Whitby Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Whitby. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/whi/loft-insulation-whitby',
    siteName: 'Free Loft Insulation in Whitby',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-whitby.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Whitby',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-whitby.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Whitby – Government Grants Available',
    description: 'Whitby homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-whitby.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Whitby',
    'twitter:image:alt': 'Free Loft Insulation in Whitby',
  },
};

export default function LoftInsulationWhitbyPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Whitby – Keep Your Home Warm & Save on Energy Bills
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                ...
                <p className="text-gray-600 mb-4">Maintain consistent indoor temperatures all year round</p>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                ...
                <p className="text-gray-600 mb-4">Minimise external noise for a peaceful home</p>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group">
                ...
                <p className="text-gray-600 mb-4">Boost your EPC rating for resale</p>
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Whitby homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Whitby
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We offer a wide range of insulation options suitable for all home types and budgets:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for filling awkward spaces</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Extra storage space without compromising insulation</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Areas We Serve Around Whitby
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                Our services cover Whitby and surrounding areas including:
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Whitby Town Centre', 'West Cliff', 'East Cliff', 'Ruswarp', 'Sandsend'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus nearby villages and coastal areas
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Whitby?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">High-Quality Materials – Durable and eco-friendly insulation products</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Whitby Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Whitby
            </h1>
