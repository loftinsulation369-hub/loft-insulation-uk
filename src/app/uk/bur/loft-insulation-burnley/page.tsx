...
export const metadata: Metadata = {
  ...
  description: "Apply for free loft insulation in Burnley and reduce energy bills. Local installers, government grants, and quick approval.",
  ...
  openGraph: {
    ...
    description: "Discover how to get free loft insulation in Burnley. Cut heat loss, save money, and enjoy a warmer home.",
  ...
  twitter: {
    ...
    description: 'Burnley homeowners can now qualify for free loft insulation through eco-friendly government schemes. Check eligibility today.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-white font-semibold">Save up to 25% on Heating Bills</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Loft Insulation Burnley – Save Energy, Cut Bills, Stay Warm
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Burnley homeowners who have already reduced their energy bills</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Loft Insulation in Burnley?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Up to 25% of heat can escape through an uninsulated loft. Professional loft insulation provides multiple benefits for Burnley homeowners.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Reduce Heat Loss</h3>
              <p className="text-gray-600">Up to 25% of heat escapes through uninsulated lofts</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Cut heating costs by 20-25%</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Reduce carbon footprint</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Energy-efficient homes attract buyers</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Our Loft Insulation Services in Burnley
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We provide a full range of loft insulation solutions to meet your specific needs.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Blanket (Roll) Insulation</h3>
              </div>
              <p className="text-gray-600">
                Ideal for quick installation in most homes. Easy to handle and provides excellent thermal performance.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Blown Fibre Insulation</h3>
              </div>
              <p className="text-gray-600">
                Perfect for hard-to-reach loft spaces. Provides seamless coverage and superior thermal efficiency.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Sheet Insulation</h3>
              </div>
              <p className="text-gray-600">
                Great for loft conversions and usable attic spaces. Maintains insulation while providing structural support.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Insulation Removal & Replacement</h3>
              </div>
              <p className="text-gray-600">
                Safe removal of old or damaged insulation before upgrading to modern, efficient materials.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">We inspect your loft and assess insulation needs.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Expert Recommendation</h3>
              <p className="text-gray-600">We suggest the best materials and thickness for maximum efficiency.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Our skilled team installs insulation quickly and with minimal disruption.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Post-Installation Check</h3>
              <p className="text-gray-600">We ensure everything meets UK building regulations and energy efficiency standards.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Us for Loft Insulation in Burnley?
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Fully Qualified & Certified</h3>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">High-Quality Materials</h3>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">5-Star Customer Reviews</h3>
              <p className="text-gray-600">Excellent reputation</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Areas We Serve Around Burnley
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We proudly offer loft insulation services not only in Burnley but also in surrounding areas including Padiham, Brierfield, Nelson, Accrington, and Colne.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Burnley City</h3>
              </div>
              <p className="text-gray-600">Complete coverage of Burnley with local expertise and understanding.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Padiham & Brierfield</h3>
              </div>
              <p className="text-gray-600">Extensive coverage of Padiham, Brierfield, and Nelson.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Accrington & Colne</h3>
              </div>
              <p className="text-gray-600">We reach Accrington, Colne, and surrounding Lancashire areas.</p>
            </div>
          </div>
        </div>
      </section>
