...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Hartlepool – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Hartlepool and cut energy bills. Local installers, government grants, and fast approval available.",
  keywords: ["free loft insulation Hartlepool", "loft insulation grants Hartlepool", "Hartlepool loft insulation scheme", "government free loft insulation Hartlepool", "loft insulation installers Hartlepool", "energy saving loft insulation Hartlepool", "eco loft insulation Hartlepool", "free home insulation Hartlepool"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/har/loft-insulation-hartlepool',
    languages: {
      'en-US': '/uk/har/loft-insulation-hartlepool',
      'en-GB': '/uk/har/loft-insulation-hartlepool',
      'en': '/uk/har/loft-insulation-hartlepool',
    },
  },
  openGraph: {
    title: "Hartlepool's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Hartlepool. Reduce heat loss, save money, and enjoy a warmer home this winter.",
    url: 'https://www.loft-insulation-services-uk.com/uk/har/loft-insulation-hartlepool',
    siteName: 'Free Loft Insulation in Hartlepool',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-hartlepool.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Hartlepool',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-hartlepool.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Hartlepool – Government Grants Available',
    description: 'Hartlepool homeowners may now qualify for free loft insulation through government schemes. Check your eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-hartlepool.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Hartlepool',
    'twitter:image:alt': 'Free Loft Insulation in Hartlepool',
  },
};

export default function LoftInsulationHartlepoolPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Hartlepool – Save Energy & Cut Bills
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional Loft Insulation Services in Hartlepool
            </p>
            <p className="text-lg mb-8 text-blue-200">
              At [Your Company Name], we specialise in high-quality loft insulation in Hartlepool, helping homeowners and landlords reduce heat loss, lower energy bills, and make homes more comfortable all year round. With over a decade of experience and a nationwide network of 5,000 certified installers, we deliver reliable, eco-friendly insulation solutions tailored to your property.
            </p>
            <p className="text-lg mb-8 text-blue-200">
              Whether you own a modern home or a traditional property, our expert team ensures your loft is insulated to UK building regulations, improving your EPC rating and increasing property value.
            </p>
     ...
     {/* Why Loft Insulation Matters Section */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Hartlepool homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Hartlepool
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for most loft types and a cost-effective choice.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for awkward or hard-to-reach loft spaces.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Best for loft conversions or when loft flooring is required.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">We remove old or damaged insulation and replace it with modern, high-performance materials.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Detailed inspection to assess insulation needs.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-green-600">2</span>
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Transparent Quote</h3>
                <p className="text-gray-600">No hidden costs, clear pricing.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Carried out by certified experts.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Advice to keep your loft energy efficient.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Hartlepool Residents Trust Us
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Over 10 Years of Experience in Loft Insulation</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fully Qualified & Insured Installers</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">High-Quality, Sustainable Materials</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Trusted by Over 10 Lakh (1 Million) Satisfied Customers Nationwide</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Areas We Serve Near Hartlepool
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                We provide loft insulation services across Hartlepool and surrounding areas, including Seaton Carew, West View, Greatham, and Dalton Piercy.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Hartlepool', 'Seaton Carew', 'West View', 'Greatham', 'Dalton Piercy'].map((area, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Hartlepool Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Hartlepool
            </h1>
