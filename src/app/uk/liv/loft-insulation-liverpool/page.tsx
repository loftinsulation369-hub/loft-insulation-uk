...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Liverpool – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Liverpool and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Liverpool", "loft insulation grants Liverpool", "Liverpool loft insulation scheme", "government free loft insulation Liverpool", "loft insulation installers Liverpool", "energy saving loft insulation Liverpool", "eco loft insulation Liverpool", "free home insulation Liverpool"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/liv/loft-insulation-liverpool',
    languages: {
      'en-US': '/uk/liv/loft-insulation-liverpool',
      'en-GB': '/uk/liv/loft-insulation-liverpool',
      'en': '/uk/liv/loft-insulation-liverpool',
    },
  },
  openGraph: {
    title: "Liverpool's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Liverpool. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/liv/loft-insulation-liverpool',
    siteName: 'Free Loft Insulation in Liverpool',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-liverpool.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Liverpool',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-liverpool.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Liverpool – Government Grants Available',
    description: 'Liverpool homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-liverpool.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Liverpool',
    'twitter:image:alt': 'Free Loft Insulation in Liverpool',
  },
};

export default function LoftInsulationLiverpoolPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Liverpool – Cut Energy Bills & Stay Warm
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Expert Loft Insulation Services in Liverpool
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Liverpool homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Solutions in Liverpool
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for irregular or hard-to-reach loft spaces.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for loft conversions and storage areas.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Safe removal of old or contaminated insulation materials.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">We assess your property and recommend the best insulation type.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Clear pricing with no hidden fees.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Fast, clean, and to the highest standards.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Ensuring your insulation remains effective.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">10+ years of insulation expertise</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fully certified and insured installers</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Competitive pricing with flexible payment options</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Thousands of happy customers nationwide</h3>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                We cover Liverpool city centre and all surrounding areas, including Bootle, Crosby, Birkenhead, Wallasey, Speke, and beyond.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Anfield', 'Bootle', 'Everton', 'Speke', 'Crosby', 'Birkenhead', 'Wallasey', 'Toxteth'].map((area, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Liverpool Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Liverpool
            </h1>
