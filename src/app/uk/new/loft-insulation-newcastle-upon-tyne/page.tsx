...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Newcastle upon Tyne – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Newcastle upon Tyne and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Newcastle upon Tyne", "loft insulation grants Newcastle upon Tyne", "Newcastle upon Tyne loft insulation scheme", "government free loft insulation Newcastle upon Tyne", "loft insulation installers Newcastle upon Tyne", "energy saving loft insulation Newcastle upon Tyne", "eco loft insulation Newcastle upon Tyne", "free home insulation Newcastle upon Tyne"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/new/loft-insulation-newcastle-upon-tyne',
    languages: {
      'en-US': '/uk/new/loft-insulation-newcastle-upon-tyne',
      'en-GB': '/uk/new/loft-insulation-newcastle-upon-tyne',
      'en': '/uk/new/loft-insulation-newcastle-upon-tyne',
    },
  },
  openGraph: {
    title: "Newcastle upon Tyne's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Newcastle upon Tyne. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/new/loft-insulation-newcastle-upon-tyne',
    siteName: 'Free Loft Insulation in Newcastle upon Tyne',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-newcastle-upon-tyne.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Newcastle upon Tyne',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-newcastle-upon-tyne.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Newcastle upon Tyne – Government Grants Available',
    description: 'Newcastle upon Tyne homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-newcastle-upon-tyne.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Newcastle upon Tyne',
    'twitter:image:alt': 'Free Loft Insulation in Newcastle upon Tyne',
  },
};

export default function LoftInsulationNewcastleUponTynePage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Newcastle upon Tyne – Energy-Saving Solutions for Your Home
            </h1>
     ...
     {/* Why Loft Insulation Matters Section */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Newcastle Upon Tyne homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Newcastle upon Tyne
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We offer a range of professional insulation options to suit every property:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Quick and cost-effective</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for hard-to-reach spaces</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Insulation with extra storage space</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Areas We Serve Around Newcastle upon Tyne
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                Our services cover the entire Newcastle upon Tyne area, including Gosforth, Jesmond, Heaton, Byker, Fenham, Walker, and surrounding neighbourhoods.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Gosforth', 'Jesmond', 'Heaton', 'Byker', 'Fenham', 'Walker', 'Sandyford', 'Elswick'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus all surrounding Newcastle upon Tyne neighbourhoods
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Newcastle upon Tyne?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Local Knowledge – Experienced in insulating homes across the region</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Premium Materials – Energy-efficient and long-lasting products</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Competitive Prices – Affordable without compromising quality</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Professional Installation – Clean, fast, and hassle-free service</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Work Guaranteed – Peace of mind with every job</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Newcastle upon Tyne Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Newcastle upon Tyne
            </h1>
