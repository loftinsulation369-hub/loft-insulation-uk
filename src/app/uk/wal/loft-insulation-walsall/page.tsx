    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Walsall – Keep Your Home Warm & Save on Energy Bills
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional Loft Insulation Services in Walsall
            </p>
            <p className="text-lg mb-8 text-blue-200">
              Looking for trusted loft insulation services in Walsall? Our expert team provides top-quality insulation solutions designed to reduce heat loss, lower your energy bills, and improve the comfort of your home all year round. Whether you live in Aldridge, Bloxwich, or the town centre, we tailor our loft insulation services to suit Walsall's climate and your property's unique needs.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800">
                Why Loft Insulation is Essential in Walsall
              </h2>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Walsall experiences a temperate climate with cool winters and mild summers, making effective loft insulation critical to maintain energy efficiency and indoor comfort. Without proper insulation, up to 25% of your home's heat can escape through the roof.
              </p>
            </div>
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Walsall homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Loft Insulation is Important in Walsall
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <p className="text-lg text-gray-600">
                  Walsall experiences cool winters and variable weather, making efficient loft insulation essential for a cosy and energy-efficient home. Without proper insulation, up to 25% of your home's heat can escape through the roof, increasing heating costs and discomfort. Our loft insulation creates a thermal barrier to keep your home warm during winter and cool during summer.
                </p>
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Benefits of Loft Insulation in Walsall:</h3>
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Noise Reduction – Minimise outside noise for a peaceful living space</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Increase Property Value – Boost your EPC rating for resale or rental</span>
                  </li>
                </ul>
              </div>
      ...
      <section id="services" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Walsall
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We offer a variety of insulation options suitable for all homes and budgets:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for hard-to-reach spaces</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                Our services cover Walsall and surrounding areas including:
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Aldridge', 'Bloxwich', 'Darlaston', 'Pelsall', 'Willenhall'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus town centre and nearby areas
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Walsall?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Local Knowledge – Understanding of Walsall's homes and climate</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Get a Free Loft Insulation Quote in Walsall
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Stop losing heat through your roof this winter. Contact us today for a free home survey and no-obligation quote for professional loft insulation in Walsall.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Walsall Service?</h3>
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span>West Midlands Expertise</span>
                </div>
              </div>
            </div>
          </div>
