...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Manchester – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Manchester and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Manchester", "loft insulation grants Manchester", "Manchester loft insulation scheme", "government free loft insulation Manchester", "loft insulation installers Manchester", "energy saving loft insulation Manchester", "eco loft insulation Manchester", "free home insulation Manchester"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/man/loft-insulation-manchester',
    languages: {
      'en-US': '/uk/man/loft-insulation-manchester',
      'en-GB': '/uk/man/loft-insulation-manchester',
      'en': '/uk/man/loft-insulation-manchester',
    },
  },
  openGraph: {
    title: "Manchester's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Manchester. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/man/loft-insulation-manchester',
    siteName: 'Free Loft Insulation in Manchester',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-manchester.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Manchester',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-manchester.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Manchester – Government Grants Available',
    description: 'Manchester homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-manchester.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Manchester',
    'twitter:image:alt': 'Free Loft Insulation in Manchester',
  },
};

export default function LoftInsulationManchesterPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Manchester – Save Energy & Cut Heating Bills
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional Loft Insulation Services in Manchester
            </p>
            <p className="text-lg mb-8 text-blue-200">
              Looking for professional loft insulation services in Manchester? Our expert team provides high-quality insulation solutions that help you reduce heat loss, lower energy bills, and improve home comfort all year round. With years of experience, we serve homeowners, landlords, and businesses across Manchester, ensuring every property meets the latest energy efficiency standards.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Manchester homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Manchester
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We provide a complete range of loft insulation solutions tailored to your property:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Affordable and effective for most homes</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for hard-to-reach loft areas</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Foam Spray Insulation</h3>
                <p className="text-gray-600">High-performance and air-tight seal</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Combine insulation with usable loft space</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Serving All Areas of Manchester
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus all Greater Manchester areas
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Manchester?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Experienced Installers – Skilled professionals with local expertise</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Competitive Pricing – Affordable without compromising quality</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Eco-Friendly Materials – Safe and sustainable insulation options</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fast & Hassle-Free Service – Minimal disruption to your home</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fully Insured & Guaranteed – Peace of mind with every project</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Manchester Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Manchester
            </h1>
