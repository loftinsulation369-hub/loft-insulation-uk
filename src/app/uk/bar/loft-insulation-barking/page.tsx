        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Loft Insulation Barking – Save Energy & Reduce Heating Bills
            </h1>
            <p className="text-xl text-blue-100 max-w-4xl mx-auto mb-8 font-medium">
              Professional Loft Insulation Services in Barking
            </p>
            <p className="text-lg text-blue-200 max-w-4xl mx-auto mb-8">
              Looking for loft insulation in Barking that keeps your home warm, energy-efficient, and eco-friendly? Our expert installers provide high-quality loft insulation installation, replacement, and upgrades for homes across Barking and East London. With premium materials and experienced professionals, we help you reduce heat loss, lower energy bills, and improve home comfort all year round.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Barking homeowners who have already reduced their energy bills</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Our Loft Insulation Services in Barking
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">
                We install energy-efficient insulation that meets UK standards, ensuring maximum heat retention.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">
                Remove old, ineffective insulation and upgrade to modern, eco-friendly materials.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 md:col-span-2">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Loft Boarding & Insulation</h3>
              </div>
              <p className="text-gray-600">
                Add storage space to your loft without sacrificing insulation performance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Us for Loft Insulation in Barking
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Quick & Clean Installations</h3>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600">Complying with UK building regulations</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">Assess your loft space and recommend the best insulation type.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Honest, upfront pricing.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Carried out by trained experts.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Instant Savings</h3>
              <p className="text-gray-600">Notice improved warmth and reduced bills immediately.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Serving Barking & Surrounding Areas
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We provide loft insulation in Barking and across East London, including Ilford, Dagenham, Romford, Stratford, and nearby towns.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Barking & Dagenham</h3>
              </div>
              <p className="text-gray-600">Complete coverage of Barking and Dagenham with local expertise.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
              ...
              <p className="text-gray-600">Extensive coverage across East London including Ilford, Romford, and Stratford.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mr-4 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Nearby Towns</h3>
              </div>
              <p className="text-gray-600">We reach surrounding areas and nearby towns with dedicated service.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Get a Free Loft Insulation Quote in Barking
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-4xl mx-auto">
            Make your home warmer, greener, and more energy-efficient today. Contact us for a free loft insulation survey and quote in Barking.
          </p>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              FAQs – Loft Insulation Barking
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Get answers to the most commonly asked questions about loft insulation in Barking.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  How much does loft insulation cost in Barking?
                </h3>
                <p className="text-gray-700 ml-9">
                  Costs depend on loft size and materials, but we offer budget-friendly options.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                  ...
                  Do you help with insulation grants in Barking?
                </h3>
                <p className="text-gray-700 ml-9">
                  Yes, we can check if you qualify for ECO4 or other UK energy schemes.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                ...
                <p className="text-gray-700 ml-9">
                  Most lofts are fully insulated within one day.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
                ...
                <p className="text-gray-700 ml-9">
                  High-quality insulation lasts up to 40 years with minimal maintenance.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-start">
