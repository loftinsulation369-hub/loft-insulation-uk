...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Sheffield – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Sheffield and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Sheffield", "loft insulation grants Sheffield", "Sheffield loft insulation scheme", "government free loft insulation Sheffield", "loft insulation installers Sheffield", "energy saving loft insulation Sheffield", "eco loft insulation Sheffield", "free home insulation Sheffield"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/she/loft-insulation-sheffield',
    languages: {
      'en-US': '/uk/she/loft-insulation-sheffield',
      'en-GB': '/uk/she/loft-insulation-sheffield',
      'en': '/uk/she/loft-insulation-sheffield',
    },
  },
  openGraph: {
    title: "Sheffield Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Sheffield. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/she/loft-insulation-sheffield',
    siteName: 'Free Loft Insulation in Sheffield',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-sheffield.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Sheffield',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-sheffield.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Sheffield – Government Grants Available',
    description: 'Sheffield homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-sheffield.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Sheffield',
    'twitter:image:alt': 'Free Loft Insulation in Sheffield',
  },
};

export default function LoftInsulationSheffieldPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Sheffield – Keep Your Home Warm & Save on Energy Bills
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Sheffield homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Sheffield
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We provide a range of insulation options suitable for all property types:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for filling hard-to-reach areas</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                Our services cover Sheffield and surrounding neighbourhoods including:
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Crookes', 'Dore', 'Ecclesall', 'Hillsborough', 'Heeley', 'Sharrow'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus city centre and nearby areas
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Sheffield?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">High-Quality Materials – Durable and eco-friendly products</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Workmanship Guaranteed – Peace of mind with every project</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Get a Free Loft Insulation Quote in Sheffield
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Stop losing heat through your roof this winter. Contact us today for a free home survey and no-obligation quote for professional loft insulation in Sheffield.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Sheffield Service?</h3>
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span>South Yorkshire Expertise</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Sheffield
            </h1>
