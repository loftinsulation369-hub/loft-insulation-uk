...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Craigavon – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Craigavon and reduce energy bills. Local expert installers, government grants, fast approval.",
  keywords: ["free loft insulation Craigavon", "loft insulation grants Craigavon", "Craigavon loft insulation scheme", "government free loft insulation Craigavon", "loft insulation installers Craigavon", "energy saving loft insulation Craigavon", "eco loft insulation Craigavon", "free home insulation Craigavon"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/cra/loft-insulation-craigavon',
    languages: {
      'en-US': '/uk/cra/loft-insulation-craigavon',
      'en-GB': '/uk/cra/loft-insulation-craigavon',
      'en': '/uk/cra/loft-insulation-craigavon',
    },
  },
  openGraph: {
    title: "Craigavon's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Craigavon. Cut heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/cra/loft-insulation-craigavon',
    siteName: 'Free Loft Insulation in Craigavon',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-craigavon.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Craigavon',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-craigavon.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Craigavon – Government Grants Available',
    description: 'Craigavon homeowners can now qualify for free loft insulation through government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-craigavon.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Craigavon',
    'twitter:image:alt': 'Free Loft Insulation in Craigavon',
  },
};

export default function LoftInsulationCraigavonPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Craigavon – Keep Your Home Warm & Energy Efficient
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional Loft Insulation Services in Craigavon
            </p>
            <p className="text-lg mb-8 text-blue-200">
              At [Your Company Name], we provide high-quality loft insulation services in Craigavon to help homeowners save money, reduce energy waste, and enjoy a comfortable living environment all year round. With over 10 years of experience and a network of trusted, fully certified installers, we ensure your loft is insulated to the highest UK energy efficiency standards.
            </p>
            <p className="text-lg mb-8 text-blue-200">
              Whether your home is a modern property, a traditional house, or a bungalow, our expert team delivers tailored insulation solutions to suit your needs and budget.
            </p>
   ...
   {/* Why Loft Insulation Matters Section */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Craigavon homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Solutions in Craigavon
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">An affordable, quick-to-install option perfect for most loft spaces.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for lofts with awkward or restricted access.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Great for loft conversions or areas requiring storage.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Insulation Removal & Replacement</h3>
                <p className="text-gray-600">We safely remove old or damaged insulation and replace it with modern, high-performance materials.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Solutions designed for maximum energy savings.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Fast, tidy, and compliant with UK building regulations.</p>
              </div>
              <div className="text-center">
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Craigavon?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Over 10 Years of Experience</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Eco-Friendly, High-Quality Materials</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Competitive Prices</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Excellent Customer Reviews</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Areas We Cover in Craigavon
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                We provide loft insulation services in Portadown, Lurgan, Waringstown, Dollingstown, Tandragee, and surrounding areas.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {['Portadown', 'Lurgan', 'Waringstown', 'Dollingstown', 'Tandragee'].map((area, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Get Your Free Loft Insulation Quote in Craigavon Today
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Upgrade your home with professional loft insulation in Craigavon and start saving on energy bills today. Call us now or fill in our online form for a free survey and no-obligation quote.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Craigavon Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Craigavon
            </h1>
