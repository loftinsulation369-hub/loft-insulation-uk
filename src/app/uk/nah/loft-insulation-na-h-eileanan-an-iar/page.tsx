...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Na h-Eileanan an Iar – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Na h-Eileanan an Iar and lower your energy bills. Local installers, government grants, fast approval available.",
  keywords: ["free loft insulation Na h-Eileanan an Iar", "loft insulation grants Na h-Eileanan an Iar", "Na h-Eileanan an Iar loft insulation scheme", "government free loft insulation Na h-Eileanan an Iar", "loft insulation installers Na h-Eileanan an Iar", "energy saving loft insulation Na h-Eileanan an Iar", "eco loft insulation Na h-Eileanan an Iar", "free home insulation Na h-Eileanan an Iar"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/nah/loft-insulation-na-h-eileanan-an-iar',
    languages: {
      'en-US': '/uk/nah/loft-insulation-na-h-eileanan-an-iar',
      'en-GB': '/uk/nah/loft-insulation-na-h-eileanan-an-iar',
      'en': '/uk/nah/loft-insulation-na-h-eileanan-an-iar',
    },
  },
  openGraph: {
    title: "Na h-Eileanan an Iar's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Na h-Eileanan an Iar. Reduce heat loss, save money, and enjoy a warmer home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/nah/loft-insulation-na-h-eileanan-an-iar',
    siteName: 'Free Loft Insulation in Na h-Eileanan an Iar',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-na-h-eileanan-an-iar.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Na h-Eileanan an Iar',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-na-h-eileanan-an-iar.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Na h-Eileanan an Iar – Government Grants Available',
    description: 'Na h-Eileanan an Iar homeowners may qualify for free loft insulation under government schemes. Check eligibility today.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-na-h-eileanan-an-iar.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Na h-Eileanan an Iar',
    'twitter:image:alt': 'Free Loft Insulation in Na h-Eileanan an Iar',
  },
};

export default function LoftInsulationNaHEileananAnIarPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Na h-Eileanan an Iar – Keep Warm, Save Energy
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Na H Eileanan An Iar homeowners who have already reduced their energy bills</p>
      ...
      {/* Why Insulation is Vital */}
      <section id="why-insulation" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Loft Insulation is Vital in Na h-Eileanan an Iar
            </h2>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Lower Heating Bills – Save up to 30% on energy costs</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Better Temperature Control – Warm in winter, cool in summer</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Environmental Benefits – Reduce your carbon footprint</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Noise Reduction – Quieter, more peaceful home</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mr-3 mt-1">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-gray-700">Increased Property Value – Better EPC rating for resale or rental</span>
                  </li>
                </ul>
              </div>
      ...
      <section id="services" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Na h-Eileanan an Iar
            </h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              We offer a range of insulation options tailored to the needs of homes in the Outer Hebrides:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Affordable and effective for most loft spaces</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Great for hard-to-reach areas</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Airtight, high-performance insulation</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Loft Boarding & Storage</h3>
                <p className="text-gray-600">Combine insulation with practical storage solutions</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Covering All Areas of Na h-Eileanan an Iar
            </h2>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                From Stornoway, Benbecula, Barra, and North Uist to remote island communities, our team is ready to deliver quick, efficient, and professional insulation services wherever you are.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Stornoway', 'Benbecula', 'Barra', 'North Uist', 'South Uist', 'Lewis', 'Harris', 'Vatersay'].map((area, index) => (
              ...
              <p className="text-sm text-gray-600 mt-4 text-center">
                Plus all remote island communities
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Na h-Eileanan an Iar?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Local Knowledge – We understand island weather and housing needs</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">High-Quality Materials – Durable, energy-efficient, and eco-friendly</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Affordable Prices – Competitive rates without compromising quality</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fast & Tidy Installation – Minimal disruption to your daily life</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Fully Guaranteed Work – Peace of mind with every project</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Take the first step towards a warmer, more energy-efficient home. Contact our team for a free survey and no-obligation quote for loft insulation in Na h-Eileanan an Iar.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Western Isles Service?</h3>
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span>Island Weather Expertise</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Na h-Eileanan an Iar
            </h1>
