...
export const metadata: Metadata = {
  title: "Free Loft Insulation in Dundee – Save Energy & Reduce Bills",
  description: "Apply for free loft insulation in Dundee and lower energy bills. Skilled installers, government grants, fast approval.",
  keywords: ["free loft insulation Dundee", "loft insulation grants Dundee", "Dundee loft insulation scheme", "government free loft insulation Dundee", "loft insulation installers Dundee", "energy saving loft insulation Dundee", "eco loft insulation Dundee", "free home insulation Dundee"],
  authors: [{ name: "LIS UK" }],
  creator: "LIS UK",
  ...
  alternates: {
    canonical: '/uk/dun/loft-insulation-dundee',
    languages: {
      'en-US': '/uk/dun/loft-insulation-dundee',
      'en-GB': '/uk/dun/loft-insulation-dundee',
      'en': '/uk/dun/loft-insulation-dundee',
    },
  },
  openGraph: {
    title: "Dundee's Free Loft Insulation Scheme – Check Your Eligibility Today",
    description: "Discover how to get free loft insulation in Dundee. Reduce heat loss, save money, and enjoy a warmer, more efficient home.",
    url: 'https://www.loft-insulation-services-uk.com/uk/dun/loft-insulation-dundee',
    siteName: 'Free Loft Insulation in Dundee',
    images: [
      {
        url: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-dundee.webp',
        width: 1200,
        height: 630,
        alt: 'Free Loft Insulation in Dundee',
        secureUrl: 'https://d3euc6irt3la1j.cloudfront.net/loft-insulation-dundee.webp',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Get Free Loft Insulation in Dundee – Government Grants Available',
    description: 'Homeowners in Dundee may qualify for free loft insulation via government schemes. Check eligibility now.',
    images: ['https://d3euc6irt3la1j.cloudfront.net/loft-insulation-dundee.webp'],
    creator: '@l4rgindia',
  },
  robots: {
    index: true,
  ...
  other: {
    'og:image:alt': 'Free Loft Insulation in Dundee',
    'twitter:image:alt': 'Free Loft Insulation in Dundee',
  },
};

export default function LoftInsulationDundeePage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Loft Insulation Dundee – Save Energy, Stay Warm
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Expert Loft Insulation Services in Dundee & Surrounding Areas
            </p>
     ...
     {/* Why Loft Insulation Matters Section */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 mb-6">Join thousands of Dundee homeowners who have already reduced their energy bills</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Our Loft Insulation Services in Dundee
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Affordable, quick to install, and effective for most standard lofts.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Ideal for hard-to-reach or awkward loft spaces.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Perfect for loft conversions where storage or flooring is needed.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">We remove old, inefficient insulation and replace it with high-performance, eco-friendly materials.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">We inspect your loft and recommend the most efficient insulation type.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Clear, competitive pricing with no hidden fees.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Completed quickly, cleanly, and to UK building regulations.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-orange-600">4</span>
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Post-Installation Support</h3>
                <p className="text-gray-600">We ensure your insulation continues to perform at its best.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="why-choose-us" className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
              Why Choose Us for Loft Insulation in Dundee?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Sustainable, High-Performance Materials</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Affordable Pricing & Flexible Options</h3>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">Trusted by Thousands of UK Homeowners</h3>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-xl">
              <p className="text-lg text-gray-700 mb-6 text-center">
                We provide loft insulation services throughout Dundee and nearby locations including Broughty Ferry, Monifieth, Invergowrie, and Longforgan.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {['Dundee', 'Broughty Ferry', 'Monifieth', 'Invergowrie', 'Longforgan'].map((area, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Get Your Free Loft Insulation Quote in Dundee
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Upgrade your home comfort and lower your energy bills with professional loft insulation in Dundee. Call us today or fill in our online enquiry form to book your free, no-obligation survey.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4">Why Choose Our Dundee Service?</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Free Loft Insulation in Dundee
            </h1>
